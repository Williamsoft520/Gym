...
namespace System
{
    ...
    public static class CollectionExtension
    {
        ...
        //public static T GetOrDefault<T>(this NameValueCollection collection, string name, T defaultValue)
        //{
        //    return collection.Get(name).To<T>(defaultValue);
        //}
        ///// <summary>
        ///// 获取与 System.Collections.Specialized.NameValueCollection 中的指定键关联的值，当集合中不存在指定名称的对象时，返回默认类型的默认值。
        ///// </summary>
        ...
        ///// <param name="name">项的 System.String 键，该项包含要获取的值。键可以是 null。</param>
        ///// <returns>默认值或值。</returns>
        //public static T GetOrDefault<T>(this NameValueCollection collection, string name)
        //{
        //    return GetOrDefault(collection, name, default(T));
        //}
        #endregion
